...
public class AdminController {
	...
	@GetMapping("hotels/booked/{city}")
	public ResponseEntity<List<HotelResponseDTO>> getAllBookedHotels(@PathVariable String city){
		logger.info("Request received to get all booked hotels.");
		List<HotelResponseDTO> allBookedHotels=hotelService.getAllBookedHotelsByCity(city);
		logger.info("Successfully retrieved all booked hotels.");
		return new ResponseEntity<List<HotelResponseDTO>>(allBookedHotels,HttpStatus.OK);
	}
